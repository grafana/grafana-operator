...
func (r *AdminSecretReconciler) Reconcile(ctx context.Context, cr *v1beta1.Grafana, _vars *v1beta1.OperatorReconcileVars, scheme *runtime.Scheme) (v1beta1.OperatorStageStatus, error) {
