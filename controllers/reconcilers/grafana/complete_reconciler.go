...
func (r *CompleteReconciler) Reconcile(ctx context.Context, cr *v1beta1.Grafana, _vars *v1beta1.OperatorReconcileVars, _scheme *runtime.Scheme) (v1beta1.OperatorStageStatus, error) {
