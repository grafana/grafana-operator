...
func (r *IngressReconciler) Reconcile(ctx context.Context, cr *v1beta1.Grafana, _vars *v1beta1.OperatorReconcileVars, scheme *runtime.Scheme) (v1beta1.OperatorStageStatus, error) {
	log := logf.FromContext(ctx).WithName("IngressReconciler")

	if r.isOpenShift {
		log.Info("reconciling route", "platform", "openshift")
		return r.reconcileRoute(ctx, cr, scheme)
	} else {
		log.Info("reconciling ingress", "platform", "kubernetes")
		return r.reconcileIngress(ctx, cr, scheme)
	}
}

func (r *IngressReconciler) reconcileIngress(ctx context.Context, cr *v1beta1.Grafana, scheme *runtime.Scheme) (v1beta1.OperatorStageStatus, error) {
...
func (r *IngressReconciler) reconcileRoute(ctx context.Context, cr *v1beta1.Grafana, scheme *runtime.Scheme) (v1beta1.OperatorStageStatus, error) {
