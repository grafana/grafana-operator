...
func TestFetchDashboardFromGrafanaCom(t *testing.T) {
	...
	assert.False(t, dashboard.Status.Content.Timestamp.Time.IsZero(), "ContentTimestamp should have been set")
	assert.NotEmpty(t, dashboard.Status.Content.Url, "ContentUrl should have been set")
}
