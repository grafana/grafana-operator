...
func FetchDashboardFromConfigMap(ctx context.Context, cr v1beta1.GrafanaContentResource, cl client.Client) ([]byte, error) {
	...
	err := cl.Get(ctx, selector, dashboardConfigMap)
	if err != nil {
		return nil, err
	}
