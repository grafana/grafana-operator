...
import (
	...
	grafanav1alpha1 "github.com/integr8ly/grafana-operator/v3/apis/integreatly/v1alpha1"
...
// +kubebuilder:rbac:groups=integreatly.integreatly.org,resources=grafanadashboards,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=integreatly.integreatly.org,resources=grafanadashboards/status,verbs=get;update;patch
...
func (r *GrafanaDashboardReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	return ctrl.NewControllerManagedBy(mgr).
		For(&integreatlyv1alpha1.GrafanaDashboard{}).
		Complete(r)
}
