...
require (
	...
	github.com/grafana/grafana/apps/folder/v13 v13.0.2
	github.com/grafana/grafana/pkg/apimachinery/v13 v13.0.2
...
require (
	...
	github.com/grafana/grafana-app-sdk v0.54.1 // indirect
