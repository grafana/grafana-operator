...
func (in *GrafanaConfigLogConsole) DeepCopyInto(out *GrafanaConfigLogConsole) {
	*out = *in
<<<<<<< HEAD:api/v1alpha1/zz_generated.deepcopy.go
	return
=======
>>>>>>> 5648e8a4... fix imports:api/integreatly/v1alpha1/zz_generated.deepcopy.go
}
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *GrafanaSpec) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
