...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPRouteGatewayV1) DeepCopyInto(out *HTTPRouteGatewayV1) {
	*out = *in
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	if in.Spec != nil {
		in, out := &in.Spec, &out.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPRouteGatewayV1.
func (in *HTTPRouteGatewayV1) DeepCopy() *HTTPRouteGatewayV1 {
	if in == nil {
		return nil
	}
	out := new(HTTPRouteGatewayV1)
