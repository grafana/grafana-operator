...
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v5.24.0](https://img.shields.io/badge/AppVersion-v5.24.0-informational?style=flat-square)
...
```shell
helm upgrade -i --take-ownership --set crds.immutable=false grafana-operator oci://ghcr.io/grafana/helm-charts/grafana-operator --version 5.24.0
```
...
| dashboardsDir.emptyDir | object | `{}` | emptyDir options for dashboards-dir |
...
| metricsService.ipFamilyPolicy | string | `""` | IP family policy to use, e.g., SingleStack, PreferDualStack, or RequireDualStack |
