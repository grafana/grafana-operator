...
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v5.22.0](https://img.shields.io/badge/AppVersion-v5.22.0-informational?style=flat-square)
...
```shell
helm upgrade -i --take-ownership --set crds.immutable=false grafana-operator oci://ghcr.io/grafana/helm-charts/grafana-operator --version 5.22.0
```
