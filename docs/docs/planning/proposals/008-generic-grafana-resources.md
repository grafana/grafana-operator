...
Platform](https://github.com/grafana/grafana-app-sdk/blob/main/docs/application-design/platform-concepts.md)
in Grafana, it is now possible to extend Grafana in a simliar way to kubernetes.
...
The above example applies the `d7cd0c85-5c53-452c-bbef-84b5fe669ef2` to all instances matched by `env=dev`.
