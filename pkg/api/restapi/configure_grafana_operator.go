...
func configureAPI(api *operations.GrafanaOperatorAPI) http.Handler {
	...
	if api.CreateGrafanaHandler == nil {
		api.CreateGrafanaHandler = operations.CreateGrafanaHandlerFunc(func(params operations.CreateGrafanaParams, principal interface{}) middleware.Responder {
	...
	if api.ListGrafanasHandler == nil {
		api.ListGrafanasHandler = operations.ListGrafanasHandlerFunc(func(params operations.ListGrafanasParams, principal interface{}) middleware.Responder {
