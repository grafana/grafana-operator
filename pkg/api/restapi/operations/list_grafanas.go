...
type ListGrafanasHandlerFunc func(ListGrafanasParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListGrafanasHandlerFunc) Handle(params ListGrafanasParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// ListGrafanasHandler interface for that can handle valid list grafanas params
type ListGrafanasHandler interface {
	Handle(ListGrafanasParams, interface{}) middleware.Responder
}
