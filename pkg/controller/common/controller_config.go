...
const (
	...
	GrafanaAuthProxyDeploymentName  = "grafana-proxy-deployment"
	GrafanaAuthProxyIngressName     = "grafana-proxy-ingress"
	GrafanaAuthProxyServiceName     = "grafana-proxy-service"
	GrafanaAuthProxyConfigMapName   = "grafana-proxy-config"
