...
type DatasourcePipelineImpl struct {
	datasource *v1alpha2.GrafanaDataSource
	contents   string
	hash       string
}

func NewDatasourcePipeline(ds *v1alpha2.GrafanaDataSource) DatasourcePipeline {
...
func (i *DatasourcePipelineImpl) parse() error {
	datasources := struct {
		...
		Datasources []v1alpha2.GrafanaDataSourceFields `json:"datasources"`
	}{
