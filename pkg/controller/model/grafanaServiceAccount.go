...
func getServiceAccountLabels(cr *v1alpha2.Grafana) map[string]string {
...
func getServiceAccountAnnotations(cr *v1alpha2.Grafana) map[string]string {
	if cr.Spec.ServiceAccount == nil {
		return nil
	}
...
func GrafanaServiceAccount(cr *v1alpha2.Grafana) *v1.ServiceAccount {
...
func GrafanaServiceAccountSelector(cr *v1alpha2.Grafana) client.ObjectKey {
...
func GrafanaServiceAccountReconciled(cr *v1alpha2.Grafana, currentState *v1.ServiceAccount) *v1.ServiceAccount {
