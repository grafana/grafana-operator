...
func getAdminUser(cr *v1alpha2.Grafana, current *v12.Secret) []byte {
...
func getAdminPassword(cr *v1alpha2.Grafana, current *v12.Secret) []byte {
...
func getData(cr *v1alpha2.Grafana, current *v12.Secret) map[string][]byte {
...
func AdminSecret(cr *v1alpha2.Grafana) *v12.Secret {
	return &v12.Secret{
...
func AdminSecretReconciled(cr *v1alpha2.Grafana, currentState *v12.Secret) *v12.Secret {
	reconciled := currentState.DeepCopy()
	reconciled.Data = getData(cr, currentState)
	return reconciled
}

func AdminSecretSelector(cr *v1alpha2.Grafana) client.ObjectKey {
