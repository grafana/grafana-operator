...
func GrafanaDatasourcesConfig(cr *v1alpha1.Grafana) (*v1.ConfigMap, error) {
...
func GrafanaDatasourcesConfigReconciled(cr *v1alpha1.Grafana, currentState *v1.ConfigMap) (*v1.ConfigMap, error) {
