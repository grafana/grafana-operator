	...
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Required: []string{"phase", "id", "lastConfig"},
			},
		},
	}
}
	...
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Required: []string{"adminPassword", "adminUser", "anonymous", "basicAuth", "config", "disableLoginForm", "disableSignoutMenu", "logLevel"},
			},
		},
		Dependencies: []string{
			"github.com/integr8ly/grafana-operator/pkg/apis/integreatly/v1alpha1.GrafanaConfig", "github.com/integr8ly/grafana-operator/pkg/apis/integreatly/v1alpha1.GrafanaIngress", "github.com/integr8ly/grafana-operator/pkg/apis/integreatly/v1alpha1.GrafanaService", "k8s.io/api/core/v1.Container", "k8s.io/apimachinery/pkg/apis/meta/v1.LabelSelector"},
	}
}
